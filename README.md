...
Maven dependency details are [here](https://mvnrepository.com/artifact/io.github.toolfactory/narcissus) (only Linux x64, Linux arm64, Windows x64, macOS x64 and macOS arm64 are currently supported).
